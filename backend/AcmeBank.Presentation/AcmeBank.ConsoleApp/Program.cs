...
<<<<<<< Updated upstream:backend/AcmeBank.Presentation/AcmeBank.ConsoleApp/Program.cs
...
>>>>>>> Stashed changes:acmebanktestproject/program.cs
    {
        Console.WriteLine(""" 
        Welcome to Acme Bank!This is the teller login screen. 
...
=======
    ...
    public static void AccountInformation()
    {
        TellerMenu account = new TellerMenu();
        account.tellerAccountMenu();
    }
